...
exports.updateSlot = exports.deleteSlot = exports.deleteProduct = exports.addSlot = exports.updateProduct = exports.addProduct = exports.getProductBySlug = exports.getProductById = exports.getProducts = void 0;
...
const deleteSlot = async (req, res) => {
    try {
        const { id } = req.params;
        const bookingCount = await prisma_1.default.bookingSlot.count({
            where: {
                slotId: id,
            },
        });
        if (bookingCount > 0) {
            return res.status(400).json({
                success: false,
                message: "This slot cannot be deleted because bookings exist.",
            });
        }
        const lockCount = await prisma_1.default.slotLock.count({
            where: {
                slotId: id,
            },
        });
        if (lockCount > 0) {
            return res.status(400).json({
                success: false,
                message: "This slot cannot be deleted because locked dates exist.",
            });
        }
...
const updateSlot = async (req, res) => {
    try {
        ...
        const overlap = existingSlots.some((s) => startTime < s.endTime &&
            endTime > s.startTime);
        if (overlap) {
            return res.status(400).json({
                success: false,
